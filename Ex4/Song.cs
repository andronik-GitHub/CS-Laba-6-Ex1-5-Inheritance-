...
class Song
{
    ...
    // Повертає хвилини пісні (не враховуючи секунди)
    ...
    // Перевірка недійсного винятка у хвилинах пісні
    ...
    // Перевірка недійсного винятка у секундах пісні
    ...
    // Перевірка недійсного винятка довжини пісні
